                    ...
                    <div class="col-lg-8">
                        <div class="header-top-left-four">
                            <div class="trending-box">
                                <div class="icon"><img src="{{asset('assets/img/icon/trending_icon.svg')}}" alt=""></div>
                                <span>Trending</span>
                                <div class="shape">
            ...
            <div class="offCanvas-body">
                ...
                <div class="offCanvas-content">
                    <div class="offCanvas-logo logo">
                        <a href="index.html" class="logo-dark"><img src="{{asset('assets/img/logo/logo.png')}}" alt="Logo"></a>
                        <a href="index.html" class="logo-light"><img src="{{asset('assets/img/logo/w_logo.png')}}" alt="Logo"></a>
                    </div>
                    ...
                    <ul class="offCanvas-instagram list-wrap">
                        <li><a href="assets/img/blog/hr_post01.jpg" class="popup-image"><img src="{{asset('assets/img/blog/hr_post01.jpg')}}" alt="img"></a></li>
                        <li><a href="assets/img/blog/hr_post02.jpg" class="popup-image"><img src="{{asset('assets/img/blog/hr_post02.jpg')}}" alt="img"></a></li>
                        <li><a href="assets/img/blog/hr_post03.jpg" class="popup-image"><img src="{{asset('assets/img/blog/hr_post03.jpg')}}" alt="img"></a></li>
                        <li><a href="assets/img/blog/hr_post04.jpg" class="popup-image"><img src="{{asset('assets/img/blog/hr_post04.jpg')}}" alt="img"></a></li>
                        <li><a href="assets/img/blog/hr_post05.jpg" class="popup-image"><img src="{{asset('assets/img/blog/hr_post05.jpg')}}" alt="img"></a></li>
                        <li><a href="assets/img/blog/hr_post06.jpg" class="popup-image"><img src="{{asset('assets/img/blog/hr_post06.jpg')}}" alt="img"></a></li>
                    </ul>
                </div>
