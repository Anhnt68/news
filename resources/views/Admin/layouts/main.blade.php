...
<head>
    <meta charset="utf-8">
    <link href="{{asset('be/dist/images/logo.svg')}}" rel="shortcut icon">
...
<body class=" py-5">
    ...
    <div class="mobile-menu md:hidden">
        <div class="mobile-menu-bar">
            ...
            <a href="javascript:;" class="mobile-menu-toggler"> <i data-lucide="bar-chart-2" class="w-8 h-8 text-white transform -rotate-90"></i>
            </a>
        </div>
